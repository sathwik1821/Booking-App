  ...
  return (
    <header className="bg-brand pt-0.5 pb-2" >
        <div className='container mx-auto px-4 flex'>
            ...
            <div className="oauth flex ml-auto  items-center gap-4">
                <button className="text-blue-500 px-3 py-2 bg-gray-200 rounded hover:bg-gray-300 cursor-pointer transition">
                    Register
                </button>
                <button className="text-blue-500 px-3 py-2 bg-gray-200 rounded hover:bg-gray-300 cursor-pointer transition">
                    Login
        ...
        <div className='container mx-auto px-4 flex gap-4 overflow-auto'>
